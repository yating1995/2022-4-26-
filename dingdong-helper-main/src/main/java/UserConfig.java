...
public class UserConfig {
    ...
    //收货地址id
    public static final String addressId = "6174db40e4174a00018202e6";
    ...
    public static Map<String, String> getHeaders() {
        ...
        // ------------  填入以下6项 上面不要动 ------------
        headers.put("ddmc-device-id", "osP8I0bUfACaJ-tANLwzua5AX-x0");
        headers.put("cookie", "DDXQSESSID=657a92a20a5270392fae62794b398f57");
        headers.put("ddmc-longitude", "121.657494");
        headers.put("ddmc-latitude", "31.240657");
        headers.put("ddmc-uid", "5f8d39fbb13d460001b8ed68");
    ...
    public static Map getBody(Map<String, String> headers) {
        ...
        // ------------  填入这2项上面不要动 ------------
        body.put("s_id", "657a92a20a5270392fae62794b398f57");
        body.put("device_token", "WFWVc5eQ20p6zYTUhvVTFhM8jGI5TL1ly0742ZZJlveP6kP4H6OZARFQqvFTr6l1o0FJPFjr7dx8odpnmfxXwuBPh9iw%2FZ7tCLQ2FUPCwgjG%2Fw8gZjQgjCg%3D%3D1487577677129nars=cdf7d08cf764006ccbc794f8cb7a8f75");
        return body;
    }
}
